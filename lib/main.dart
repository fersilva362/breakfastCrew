...
import 'package:user_app/helper/loading/loading_screen.dart';
...
import 'package:user_app/view/forgot_password_view.dart';
    ...
    return BlocConsumer<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state.isLoading) {
          LoadingScreen().show(
              context: context,
              text: state.isLoadingText ?? 'Please wait a momento');
        } else {
          LoadingScreen().hide();
        }
      },
